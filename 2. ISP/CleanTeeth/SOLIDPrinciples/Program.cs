...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        //SmtpEmailService emailService = new SmtpEmailService();//NUEVO
        //var emailService = new SmtpEmailService();//NUEVO
        ...
        //    notification);//MODIFICADO
        //AppointmentService appointmentService = new AppointmentService(repository,
        //   emailService);//NUEVO/MODIFICADO
        AppointmentService appointmentService = new AppointmentService(repository,
